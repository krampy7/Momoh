  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        <a class="js-scroll-trigger" href="#page-top">Iniciar sesión</a>
      </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-9 col-lg-8 mx-auto">
                <h3 class="login-heading mb-4">¡Hola de nuevo!</h3>
                
                <!-- Es el formulario a partir del metodo post y con la etiqueta form. Los datos se enviaran a la pagina de login_back -->
