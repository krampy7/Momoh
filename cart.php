  ...
  <?php if (isset($_SESSION['USUARIO'])): ?>
    ...
    if(isset($_GET['id'])){
      ...
      if($encontro == true){
        ...
        $precio= "";
        $imagen="";
        $res= $conect->query('select * from productos where id='.$_GET['id'])or die($conect->error);
...
?>
  ...
  <html lang="en">
                ...
                ?>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="img/<?php echo $arregloCarrito[$i]['Imagen']; ?>" alt="Image" class="img-fluid" width="100" height="100">
                    </td>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row mb-5">
              ...
              <div class="col-md-6">
                <a class="btn btn-outline-primary btn-sm btn-block" href="store.php">Seguir comprando</a>
              </div>
            </div>
          </div>
    ...
    <?php else: ?>
      <?php header("Location: cuenta_necesaria.php" ); ?>
    <?php endif ?>
